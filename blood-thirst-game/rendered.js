...
$(document).ready(function () {
  const ZOMBIEMAYEM = (function () {
    ...
    // Load sounds
    (function loadSound() {
      createjs.Sound.registerSound("assets/audio/shoot_1.mp3", SHOOT_SOUND);
      createjs.Sound.registerSound("assets/audio/noammo.mp3", NO_AMMO_SOUND);
      createjs.Sound.registerSound("assets/audio/reload.mp3", RELOAD_SOUND);
      createjs.Sound.registerSound("assets/audio/3.mp3", ROAR_3);
      createjs.Sound.registerSound("assets/audio/4.mp3", ROAR_4);
      createjs.Sound.registerSound("assets/audio/5.mp3", ROAR_5);
      createjs.Sound.registerSound("assets/audio/6.mp3", ROAR_6);
      createjs.Sound.registerSound("assets/audio/laughter.mp3", LAUGHTER);
      createjs.Sound.registerSound("assets/audio/soundtrack.mp3", SOUNDTRACK);
      createjs.Sound.registerSound("assets/audio/punch_2.mp3", PUNCH_2);
      createjs.Sound.registerSound("assets/audio/punch_3.mp3", PUNCH_3);
      createjs.Sound.registerSound("assets/audio/punch_4.mp3", PUNCH_4);
    })();
    ...
    return {
      initInto: function () {
        ...
        preload(
          [
            "assets/images/zombie-1.png",
            "assets/images/zombie-2.png",
            "assets/images/zombie-3.png",
            "assets/images/wave1.png",
            "assets/images/wave2.png",
            "assets/images/wave3.png",
            "assets/images/wave4.png",
            "assets/images/frame.png",
            "assets/images/icon-pack.png",
            "assets/images/zombie-1-death.png",
            "assets/images/zombie-2-death.png",
            "assets/images/zombie-3-death.png",
            "assets/images/zombie-4.png",
            "assets/images/zombie-4-death.png",
            "assets/images/zombie-5.png",
            "assets/images/zombie-5-death.png",
            "assets/images/zombie-6.png",
            "assets/images/zombie-6-death.png",
          ],
          function () {
